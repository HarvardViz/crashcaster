crashcaster.ui_sankey = (function (cc$, $, d3) {


    var plugin_name = "crashcaster.ui_sankey";
    var plugin_version = "0.0.1";
    var READY_STATE = {_current: -1, NOT_STARTED: 0, LOADING: 1, LOADED: 2};


    function init() {
        echo("initialize crashcaster.ui_sankey");
    }

    function run() {
        echo("running crashcaster.ui_sankey");
    }
    ...
    /* END D3 SANKEY ADDITION */


    /* CUSTOMIZE THE SANKEY DIAGRAM */

    var units = "Accidents (Normalized)";
